			...
			<div class="widget-container fluid-height clearfix">
              <div class="heading">
				...
				<div class="widget-content padded form-horizontal">
				      ...
				      <div class="alert alert-success" id="labal-logened">
                      <button class="close" data-dismiss="alert" type="button">×</button>微信墙代做：<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=820358115&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:820358115:51" alt="点击这里给我发消息" title="点击这里给我发消息"/></a><a href="http:///"></a>
                    </div>
