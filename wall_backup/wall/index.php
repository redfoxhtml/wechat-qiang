...
if(isset($_SESSION['views']) && $_SESSION['views'] == true){
  ...
  header("Locaiotn:/wall/login.php");
...
<title>微信墙QQ：820358115·微信大屏幕</title>
...
<div class="mone" id="mone" onClick="viewOneHide();"><div class="leftside"><div class="part"><div class="pic"><img class="msgconimg" src="" width="100" height="100"></div><div class="username" style="color:#fff"><span style="color:#fff"></span></div></div></div><div class="rightside"><div class="rightmain"><div class="rconner"></div><span class="msgcon"></span></div></div></div>
 ...
 <div id="explan" onClick="viewExplan();" class="ui primary segment" >
    <div class="pic"><img src="images/erweima.jpg" width=362px height=362px;/></div>
    <div class="ui ribbon green label"><b style="font-size:50px;">上墙方法：</b></div><p>扫描右侧二维码添加微信公众号：<br />　　<a class="ui blue label"><b style="font-size:2.3em;line-height: 1.7em;"><?php  echo $xiaobai_wxh;?></b></a><br><b style="font-size:1.4em;line-height: 1.4em; margin-top:1em;">按照提示回复，编辑您想说的话,回复到公众号微信,即可参与上墙！</b></p>
...
var mtime;
var data=new Array();
data[0]=new Array('0','../wall/images/logo.jpg','技术支持','【820358115】欢迎来到微信上墙，发送图片和语音也可以上墙哦！','');
//var word_id='96';
var lastid='<?=$lastid ?>';
...
function messageAdd()
{
    ...
    var str='<li id=li'+cur+' onclick="viewOne('+cur+',this);"><div class=m1><div class=m2><div class="pic"><img class="circular ui image" src="'+data[cur][1]+'" width="100" height="100" /></div><div class="c f2" style="width:auto"><span>'+data[cur][2]+'</span><span>：</span<word></word></div><div class="image"><img src="http://chou.dahew.com.cn/img/pic'+data[cur][4]+'"/></div></div></div></li>';
            }
